...
namespace PurchasePortal.Web.Migrations
{
    ...
    [Migration("20240719114805_UpdateFavorit")]
    partial class UpdateFavorit
    {
            ...
            modelBuilder.Entity("PurchasePortal.Web.Models.FavoritItem", b =>
                {
                    ...
                    b.HasIndex("FavoriteUserId", "ProductId")
                        .IsUnique()
                        .HasFilter("\"FavoriteUserId\" IS NOT NULL AND \"ProductId\" IS NOT NULL");
            ...
            modelBuilder.Entity("PurchasePortal.Web.Models.FavoritItem", b =>
                {
                    ...
                    b.HasOne("PurchasePortal.Web.Models.FavoriteUser", "FavoriteUser")
                        .WithMany("FavoritItems")
