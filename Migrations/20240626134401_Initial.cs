        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionId = table.Column<string>(type: "NVARCHAR2(100)", maxLength: 100, nullable: false),
                    Status = table.Column<int>(type: "NUMBER(10)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_UserId_PostalCode",
                table: "Addresses",
                columns: new[] { "UserId", "PostalCode" },
                unique: true,
                filter: "\"UserId\" IS NOT NULL AND \"PostalCode\" IS NOT NULL");
