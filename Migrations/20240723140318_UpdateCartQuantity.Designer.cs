...
namespace PurchasePortal.Web.Migrations
{
    ...
    [Migration("20240723140318_UpdateCartQuantity")]
    partial class UpdateCartQuantity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PurchasePortal.Web.Models.Billing", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("NVARCHAR2(450)");
            ...
            modelBuilder.Entity("PurchasePortal.Web.Models.CartItem", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("NVARCHAR2(450)");
            ...
            modelBuilder.Entity("PurchasePortal.Web.Models.Billing", b =>
                {
                    b.HasOne("PurchasePortal.Web.Models.Order", "Order")
                        .WithOne("Billing")
                        .HasForeignKey("PurchasePortal.Web.Models.Billing", "OrderId");
            ...
            modelBuilder.Entity("PurchasePortal.Web.Models.Payment", b =>
                {
                    ...
                    b.HasOne("PurchasePortal.Web.Models.Order", null)
                        .WithOne("Payment")
                        .HasForeignKey("PurchasePortal.Web.Models.Payment", "OrderId1");
            ...
            modelBuilder.Entity("PurchasePortal.Web.Models.Shipping", b =>
                {
                    b.HasOne("PurchasePortal.Web.Models.Order", "Order")
                        .WithOne("Shipping")
                        .HasForeignKey("PurchasePortal.Web.Models.Shipping", "OrderId");
